...
,
        "回答データを取得できませんでした。NEW を押して再試行してください。": "Could not get the answer data. Press NEW and try again.",
        "実際の和音": "Actual chord",
        "属7の第7音は短7度として理論的に綴ります。": "The seventh of a dominant seventh chord is spelled as a minor seventh."},
    fr: {
    "HOME": "ACCUEIL",
...
,
        "回答データを取得できませんでした。NEW を押して再試行してください。": "Impossible de récupérer les données de réponse. Appuyez sur NOUVEAU et réessayez.",
        "実際の和音": "Accord réel",
        "属7の第7音は短7度として理論的に綴ります。": "La septième d’un accord de dominante est notée comme une septième mineure."}
  };
